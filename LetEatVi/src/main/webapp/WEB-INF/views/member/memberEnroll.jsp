...
<body>
    ...
    <div class="joinBox">
            ...
            <div class="form-group">
                ...
                <input type="text" name="userId" id="userId_" class="form-control"
            ...
            placeholder="나이를 입력하세요." required>
            </div>
            <!-- //나이 -->
            ...
            <input type="tel" name="phone" id="phone" maxlength="11" class="form-control"
    ...
    <!-- 카카오톡 회원가입 버튼 -->
    <button class="btn btn-warning" type="submit" value="Submit" id="loginBtn"> 카카오톡 회원가입 하기 </button>
    <!-- // 카카오톡 회원가입 버튼 -->

    <!-- 페이스북 회원가입 버튼 -->
    <button class="btn btn-primary" type="submit" value="Submit" id="loginBtn"> 페이스북 회원가입 하기 </button>
    <!-- // 페이스북 회원가입 버튼 -->

    <!-- 네이버 회원가입 버튼 -->
    <button class="btn btn-success" type="submit" value="Submit" id="loginBtn"> 네이버 회원가입 하기 </button>
    <!-- // 네이버 회원가입 버튼 -->
    </div>  
</div>
